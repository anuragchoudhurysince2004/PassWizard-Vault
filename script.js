...
class passgenerator {
  ...
  supstrongpass() {
    ...
    for (let i = 0; i < (Math.floor(Math.random() * 16) + 8); i++) {
      let tempssp = supstrongchar[Math.floor(Math.random() * supstrongchar.length)]
...
function display() {
  if (document.getElementById("1").checked) {
    document.getElementsByClassName("output")[0].innerHTML = `Generated Password is :<br><span class="gen" id="space"> ${c.supstrongpass()}` + `</span> <button onclick="copytoclipboard()" >Copy text</button>`
  }
  else if (document.getElementById("2").checked) {
    document.getElementsByClassName("output")[0].innerHTML = `Generated Password is :<br><span class="gen" id="space"> ${c.strongpass()}` + `</span> <button onclick="copytoclipboard()" >Copy text</button>`
  }
  else if (document.getElementById("3").checked) {
    document.getElementsByClassName("output")[0].innerHTML = `Generated Password is :<br><span class="gen" id="space"> ${c.weakpass()}` + `</span> <button onclick="copytoclipboard()" >Copy text</button>`
  }
